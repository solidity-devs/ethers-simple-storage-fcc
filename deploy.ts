...
interface BaseContract2 extends BaseContract {
    retrieve(): bigint;
    store(value: bigint | number | string): TransactionResponse;
}
...
async function main() {
    ...
    const contract: BaseContract2 =
        (await contractFactory.deploy(/*{ gasPrice: 100000000000 }*/)) as BaseContract2;
    const deploymentReceipt = await contract.deploymentTransaction()?.wait(3);
    ...
    //console.log("responseSignature/json", sentTxResponse.signature.toJSON())
